    ...
    <div class="MatcToolbarTop">
      <div class="MatcToolbarTopHome" :style="'width:' + layerListWidth + 'px'">
        <HomeMenu
          @select="onHomeMenu"
          :name="modelName"
          @change="onChangeModelName"
        />
      </div>

      <div
        class="MatcToolbarTopCntr"
        :style="'width:calc(100% - ' + layerListWidth + 'px)'"
      >
        <div
        ...
        <div class="MatcToolbarSection" v-show="!svgEditorVisible">
          <div
            :class="[
              ...
              { MatcToolbarItemSelected: selectedButton === 'edit' },
            ]"
            data-dojo-attach-point="editBtn"
            @click="onEdit"
            v-show="hasScreens"
          >
            <QIcon icon="Edit" />
          ...
          <div
            :class="[
              'MatcToolbarItem MatcToolbarPrimaryItem',
              { MatcToolbarItemSelected: selectedButton === 'move' },
            ]"
            data-dojo-attach-point="moveBtn"
            @click="onMove"
            v-show="hasScreens"
          >
            <QIcon icon="EditMove" />
          ...
          <div
            :class="[
              'MatcToolbarItem MatcToolbarPrimaryItem',
              { MatcToolbarItemSelected: selectedButton === 'addScreen' },
            ]"
            @click="onToolCreateScreen"
            data-dojo-attach-point="addScreenBtn"
          >
          ...
          <div
            :class="[
              'MatcToolbarItem MatcToolbarPrimaryItem',
              { MatcToolbarItemSelected: selectedButton === 'addComment' },
            ]"
        ...
        <div class="MatcToolbarTopCenterCntr" v-show="!svgEditorVisible">
          ...
          >
            ...
            >
              <div
                class="MatcToolbarItem MatcToolbarPrimaryItem"
            ...
            <div
              :class="[
                'MatcToolbarItem MatcToolbarPrimaryItem',
                { MatcToolbarItemSelected: selectedButton === 'gridResize' },
              ]"
              data-dojo-attach-point="distributeBtn"
              @click="onToolbarGridResize"
            >
            ...
            >
              <div
                :class="[
                  'MatcToolbarItem MatcToolbarPrimaryItem',
                  { MatcToolbarItemSelected: selectedButton === 'replicate' },
                ]"
                data-dojo-attach-point="replicateBtn"
                @click="onToolbarReplicate"
              >
          ...
          <div
            ...
            class="MatcToolbarSection MatcToolbarNinjaSection"
          >
        ...
        >
          ...
          <div
            class="MatcToolbarArrowDropDown"
            data-dojo-attach-point="simulatorButton"
            v-show="hasScreens"
          >
            <div
              class="MatcToolbarItem MatcToolbarPrimaryItem"
              @click="startSimilator"
            >
              <QIcon icon="Play" />
            </div>
          </div>
          ...
          <div class="MatcToolbarItem" @click="showSharing">
            <div class="MatcToobarPrimaryButton">Share</div>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    setWidgetDataBinding(dataBinding, schema, data) {
      this.logger.log(
        -1,
        "setWidgetDataBinding",
        "entry > ",
        dataBinding,
        schema
      );
      if (this._selectedWidget) {
        this.controller.updateWidgetDataBinding(
          this._selectedWidget.id,
          dataBinding,
          schema,
          data
