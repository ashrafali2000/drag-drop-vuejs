<template>
  <div
    :class="[
      'MatcTestSplash MatcTestSplashMax MactMainGradient',
      { MatcTestCustomSplash: hasSplash },
    ]"
    data-dojo-attach-point="overlay"
    :style="splashBackground"
    v-if="hasSettings"
  >
    <div v-if="hasSplash && step < 5" class="MatcTestCustomSplashPowered">
      Powered by Bawdicsoft
    </div>
    <div
      :class="[
        'MatcTestLogoCntr',
        { MatcTestLogoCntrWide: step == 1 },
        { MatcTestLogoCntrMax: step > 1 },
      ]"
    >
      <div :class="['MatcTestProgressCntr']">
        <div class="MatcTestProgressBar"></div>
        <transition name="fade">
          <div v-if="step > 2" class="MatcTestPanel">
            <div class="MatcTestHeader">
              <img src="/logo.webp" class="MatcStudioLogo" ref="logo" />
              <span class="">Bawdicsoft</span>
            </div>
            ...
            <div class="MatcTestContent" v-if="step === 3">
              <div class="MatcTestContentCntr">
                ...
                <template v-else>
                  <p
                    v-html="
                      getNlSWithReplacement('simulator.welcome.msg', {
                        name: model.name,
                      })
                    "
                  ></p>
                  <p
                    v-html="
                      getNlSWithReplacement('simulator.welcome.msg2', {
                        name: model.name,
                      })
                    "
                  ></p>
              ...
              <div class="MatcMarginTop">
                <div
                  class="MatcButton MatcButtonPrimary MatcTestStartButton"
                  @click="onShowPrivacy()"
            ...
            <div class="MatcTestContent" v-if="step === 5">
              <div class="MatcTestContentCntr">
                ...
                <p
                  class="MatcMarginTopXL"
                  v-html="getNLS('simulator.welcome.click-start')"
                ></p>
              </div>
              <div class="MatcMarginTop">
                <div
