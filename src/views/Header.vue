  ...
  <div class="MatcHeader" id="">
    <div class="MatcHeaderLeft">
      <a href="#/" ref="myPrototype">
        <img src="/logo.webp" class="MatcHeaderLogo" ref="logo" />
        Bawdicsoft
      </a>
    </div>
    <div class="container MatcHeaderCenter">
      <div class="MatcHeaderCenterLeft"></div>
      <div class="MatcHeaderCenterRight"></div>
    </div>
...
export default {
  ...
  async mounted() {
    ...
    this.addTooltip(
      this.$refs.myPrototype,
      this.$t("header.tooltip.my-prototypes")
    );
  },
};
</script>
