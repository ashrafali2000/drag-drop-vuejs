      ...
      <template v-slot:left>
        <div class="MatcStudioNav">
          ...
          <div class="MatcMarginTop MatcCollapseViewMinHidden">
            <button
              @click="showNewDialog"
              class="MatcButton MatcButtonFullWidth MatcButtonPrimary MatcRoundButton"
            >
              <QIcon icon="Plus" />
          ...
          <div
            class="MatcStudioNavRow MatcMarginTop MatcCollapseViewMinVisible"
            @click="showNewDialog"
          >
            <a class="MatcLink">
          ...
          >
            <a class="MatcLink" @click="showAppsDialog">
              <QIcon
                icon="Projects"
                :tooltip="$t('app.recent-projects')"
              ></QIcon>
            </a>
          </div>

          <div class="MatcStudioNavRow MatcMarginTop">
            <h4 class="MatcCollapseViewMinHidden">
              {{ $t("app.recent-projects") }}
            </h4>
          </div>
          ...
          <div class="MatcStudioAppList MatcMarginBottom MatcScrollContainer">
            <a
              ...
              :key="app.id"
              :href="'#/' + urlPrefix + '/' + app.id + '.html'"
              :class="[
                'MatcLink MatcCollapseViewMinHidden',
                { MatcStudioAppListSelected: selectedApp === app.id },
              ]"
            >
              <span
                class="MatcStudioAppListDot"
                :style="{ background: app.previewColor }"
              />
            ...
            <a
              ...
              class="MatcActionLink MatcCollapseViewMinHidden"
            >
