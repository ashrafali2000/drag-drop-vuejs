  ...
  <div class="MatcTest">
    <section class="section">
      <div class="container">
        ...
        <div v-if="loading" class="MatcHint">Loading...</div>
      </div>
    </section>
    ...
    <section class="section" v-if="!loading && events.length === 0">
      <div class="container">
        <div class="box is-shadowless MatcWarningBox">
          ...
          <p>
            You have not performed any test yet, therefore Bawdicsoft could not
            collect any data. Once you start testing, you will see here the heat
            maps.
          </p>
        </div>
      </div>
